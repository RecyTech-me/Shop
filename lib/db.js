...
function createProduct(db, input) {
    ...
    const result = db.prepare(`
        INSERT INTO products (
            slug, name, category, short_description, description, image_url,
...
function listPublishedProducts(db, filters = {}) {
    ...
    const orderBy = {
        price_asc: "price_cents ASC, featured DESC, created_at DESC",
        price_desc: "price_cents DESC, featured DESC, created_at DESC",
...
function listProductCategories(db, options = {}) {
    const conditions = ["TRIM(category) != ''"];
